...
(define (add x y) (+ x y)) (add 2 3)
; expect 5

(define (multiply x y) (* x y)) (multiply 2 3)
; expect 6

(define (cdadr x) (cdr (car (cdr x)))) (define evens '(0 (2 4)))
(cdadr evens)
; expect (4)

(add (multiply 2 2) (multiply 3 3))
; expect 13
...
(define x (cons 0 0)) (define y (cons 2 3)) (define z (cons x y))
(cdr (cdr z))
; expect 3
